...
public class DefaultDialogFragment extends DialogFragment implements Idialog {
    ...
    private void buidDisplay() {
        ...
        if (params.msg.equals("")) {
            content.setVisibility(View.GONE);
            parent.findViewById(R.id.scroll).setVisibility(View.GONE);
            parent.findViewById(R.id.empty).setVisibility(View.VISIBLE);
        }
    ...
    public static class DialogParams implements Serializable {
        ...
        //高亮模式map
        public transient Map<String, DialogManager.HighMode> highModeMap = new ArrayMap<>();
        //背景透明度
