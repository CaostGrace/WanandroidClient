package cn.logcode.library.Log;
...
import cn.logcode.library.Log.utils.BaseLog;
import cn.logcode.library.Log.utils.FileLog;
import cn.logcode.library.Log.utils.JsonLog;
import cn.logcode.library.Log.utils.XmlLog;

/**
 * This is a Log tool，with this you can the following
 * <ol>
 * <li>use LogUtils.d(),you could print whether the method execute,and the default tag is current class's name</li>
 * <li>use LogUtils.d(msg),you could print log as before,and you could location the method with a click in Android Studio Logcat</li>
